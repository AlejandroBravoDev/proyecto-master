...
export default function DashboardHeaderCard({ title = "Dashboard MasterFood", subtitle = "Aquí podrás ver un resumen muy completo del negocio" }) {
  const [activeFilter, setActiveFilter] = useState('Día');
  const filterOptions = ['Día', 'Mes', 'Año'];
